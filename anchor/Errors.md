...
| 6015 | 0x177f | AggregatorClosedError            | Aggregator is closed. Illegal aciton.                                       |
...
| 6019 | 0x1783 | UnauthorizedStateUpdateError     | Unathorized program state modification attempted.                           |
...
| 6024 | 0x1788 | IncorrectTokenAccountMint        | The provided token account does not point to the Switchbaord token mint.    |
